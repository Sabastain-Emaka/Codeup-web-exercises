...
console.log(sayBye(name:'Jevian'));
...
console.log(findHypotenuse(a:2, b:8));
console.log(findHypotenuse(a:3, b:9));
console.log(findHypotenuse(a:7, b:6));
